...
public class ForumUserTestSuite {
    ...
    public void testUpdate() {
        ...
        javaHelpForum.resgisterObserver(johnSmith);
        javaToolsForum.resgisterObserver(ivoneEscobar);
        javaHelpForum.resgisterObserver(jessiePinkman);
        javaToolsForum.resgisterObserver(jessiePinkman);
        //When
        javaHelpForum.addPost("Hi everyone! Could you help me with for loop?");
        javaHelpForum.addPost("Better try to use while llop in this case");
